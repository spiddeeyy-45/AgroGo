...
import com.example.agrogo.databinding.VegetableFragmentBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore
import com.razorpay.Checkout
import org.json.JSONObject

class vegetable_fragment : Fragment() {
    lateinit var Binding : VegetableFragmentBinding
    private lateinit var vegetableRecyler: mostordedre
    ...
    override fun onCreateView(
        ...
        savedInstanceState: Bundle?
         ...
         Binding=VegetableFragmentBinding.inflate(inflater,container,false)
        return Binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //backbtn handler
        Binding.backtbtn.setOnClickListener{
    ...
    private fun vegetableHandler() {
        val vegetableList = mutableListOf<remHelper>()
        vegetableRecyler = mostordedre(
            vegetableList,
        ...
        Binding.vegetableRecyler.layoutManager=LinearLayoutManager(requireContext(),LinearLayoutManager.VERTICAL,false)
        Binding.vegetableRecyler.adapter=vegetableRecyler

        firestore.collectionGroup("products")
            .whereEqualTo("category", "Vegetables")  // Server-side filtering
            .get()
            .addOnSuccessListener { result ->
                ...
                vegetableRecyler.notifyDataSetChanged()
            }
            .addOnFailureListener { exception ->
                Log.e("Firestore", "Optimized query failed: ${exception.message}")
